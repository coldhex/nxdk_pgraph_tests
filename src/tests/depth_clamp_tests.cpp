...
DepthClampTests::DepthClampTests(TestHost &host, std::string output_dir) : TestSuite(host, std::move(output_dir), "Depth Clamp") {
...
void DepthClampTests::Initialize() {
  TestSuite::Initialize();
}

void DepthClampTests::Deinitialize() {
